...
function SettingsDialog() {
  ...
  return (
    <Show when={filesState.settingsDialogOpen}>
      <div
        class="fixed inset-0 z-40 flex items-center justify-center bg-black/55 px-5 py-6"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div
          class="flex h-[min(46rem,calc(100vh-4rem))] w-[min(58rem,calc(100vw-3rem))] min-w-0 flex-col overflow-hidden rounded-md border border-border bg-bg-primary shadow-2xl"
