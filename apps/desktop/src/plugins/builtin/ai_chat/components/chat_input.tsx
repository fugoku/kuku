...
function ChatInput(): JSX.Element {
  ...
  return (
    <div class="border-t border-border bg-bg-primary p-2">
      <div class="rounded-xs border border-border bg-bg-secondary transition-colors focus-within:border-border-focused">
        <textarea
          rows={3}
          value={draft()}
          placeholder={
